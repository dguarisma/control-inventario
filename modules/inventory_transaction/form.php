<script type="text/javascript">
  function tampil_obat(input) {
    ...
    $.post("modules/inventory_transaction/inventory.php", {
      dataidobat: num,
    }, function (response) {
      $('#stok').html(response)
...
<section class="content-header">
  <h1>
    <i class="fa fa-edit icon-title"></i> Entrada de productos
  </h1>
  <ol class="breadcrumb">
    <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
    <li><a href="?module=inventory_transaction"> Entrada </a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" action="modules/inventory_transaction/proses.php?act=insert"
          ...
          <div class="box-footer">
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="?module=inventory_transaction" class="btn btn-default btn-reset">Cancelar</a>
              </div>
            </div>
          </div><!-- /.box footer -->
        </form>
