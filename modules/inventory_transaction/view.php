<section class="content-header">
  <h1>
    <i class="fa fa-sign-in icon-title"></i> Entrada de productos

    <a class="btn btn-primary btn-social pull-right" href="?module=form_inventory_transaction&form=add" title="Agregar" data-toggle="tooltip">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <div>";
          ?>
                        <a data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger btn-sm" href="modules/inventory_transaction/proses.php?act=delete&id=<?php echo $data['codigo_transaccion'];?>" onclick="return confirm('está seguro de eliminar <?php echo $data['nombre']; ?> ?');"><i style="color:#fff" class="glyphicon glyphicon-trash"></i>
                        </a>
          <?php
            echo "    </div>
                    </td>
