...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['Guardar'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO productos(codigo,nombre,precio_venta,unidad,created_user,updated_user) 
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=inventory&alert=1");
            }   
        }   
    }
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=inventory&alert=3");
            }
        }
    }       
}       
