                        ...
                        <div class="box-body">
                                ...
                                <div class="col-span-6 ml-2 sm:col-span-4 md:mr-3">
                                    ...
                                    <div class="cursor-pointer">
                                        ...
                                        <label for="photoInput"
                                            class="block text-gray-700 font-normal mb-2 text-center">
                                            Foto Perfil
                                        </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <input type="text" class="placeholder-gray-500 pl-10
                                         pr-4 rounded-lg border border-gray-400 
                                         w-full py-2 focus:outline-none focus:border-blue-400" name="name_user"
                                        value="<?= $data['name_user'] ?>" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text"
                                        ...
                                        name="username" value="<?= $data['username'] ?>" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select
                                        ...
                                        <option value=""></option>
                                        <option value="Administrador" <?php if ($data['permisos_acceso'] == 'Administrador')
                                            echo 'selected'; ?>>
                                            Administrador</option>
                                        <option value="Asistente" <?php if ($data['permisos_acceso'] == 'Asistente')
                                            echo 'selected'; ?>>Asistente</option>
                                    </select>
