...
$query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo, 6) AS codigo FROM productos ORDER BY codigo DESC LIMIT 1")
...
if ($count > 0) {
  ...
  $last_code = $data_id['codigo'];
  if (is_numeric($last_code)) {
    $codigo = intval($last_code) + 1;
    $codigo = "B" . str_pad($codigo, 6, "0", STR_PAD_LEFT);
  } else {
    // Si el último código no tiene el formato esperado, se genera un nuevo código
    $codigo = "B000001";
  }
} else {
  // Si no hay ningún registro en la tabla, se genera un nuevo código
  $codigo = "B000001";
}
      ...
      <div class="sm:w-10/12 w-full m-auto my-5">
        <div class="box box-primary py-4 px-3">
          ...
          <div class="row">
              ...
              <div class="">
                <div class="box-body box-profile">
                  <div id="load_img" class="w-[220px] h-[220px]">
                    <img class="img-responsive aspect-square object-cover" id="previewImage" src="<?= $previewImage ?>"
            ...
            <!-- /.col -->
            <div class="col-md-9">
              <form name="addForm" id="addForm" action="modules/products/proses.php?act=insert" class="form-horizontal"
                ...
                <div class="nav-tabs-custom">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="details">
                      <div class="form-group ">
                        ...
                        <div class="col-sm-4">
                          <input type="text"
                            ...
                            name="codigo" value="<?php echo $codigo; ?>" readonly required>
                        </div>
                      ...
                      <div class="form-group">
                        <label for="manufacturer_id" class="col-sm-2 control-label">Unidad</label>
                        <div class="col-sm-4">
                          <select
                            class="placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400"
                        ...
                        <div class="col-sm-4">
                          <select class="placeholder-gray-500 pl-10 pr-4 
                            ...
                            <option value="Apagado">Inactivo</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <div class="relative mb-6">
                            ...
                            <input type="number" id="precio_venta"
                              class="placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400"
                              name="precio_venta" required="" pattern="\d+(\.\d{2})?" title="precio con 2 decimales">
                          </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                          <div class="relative mb-6">
                            ...
                            <input type="number"
                              ...
                              id="stock" name="stock" required="" pattern="\d{1,11}" maxlength="11">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
