<script type="text/javascript">
  function tampil_obat(input) {
    ...
    $.post("modules/product_transaction/inventory.php", {
      dataidobat: num,
    }, function (response) {
      $('#stok').html(response)
...
<section class="content-header">
  <h1>
    <i class="fa fa-edit icon-title"></i> Salida de productos
  </h1>
  <ol class="breadcrumb">
    <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
    <li><a href="?module=product_transaction"> salida </a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" action="modules/product_transaction/proses.php?act=insert"
          method="POST" name="formObatMasuk">
          <div class="box-body">
            <?php  
            
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo_transaccion,7) as codigo FROM transaccion_inventory
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="codigo_transaccion"
                  value="<?php echo $codigo_transaccion; ?>" readonly required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="fecha_a"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="chosen-select" name="codigo" data-placeholder="-- Seleccionar producto --"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="jumlah_masuk" name="num" autocomplete="off"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select name="transaccion" id="transaccion" required class='form-control'
                  onchange="hitung_total_stok();">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">Inventario total</label>
              <div class="col-sm-5">
          ...
          <div class="box-footer">
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="?module=product_transaction" class="btn btn-default btn-reset">Cancelar</a>
              </div>
            </div>
          </div><!-- /.box footer -->
        </form>
