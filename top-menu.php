...
$query = mysqli_query($mysqli, "SELECT id_user, name_user, image, permisos_acceso FROM usuarios WHERE id_user='$_SESSION[id_user]'")
...
<li class="dropdown user user-menu">
  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
    ...
    <span class="hidden-xs"><?php echo $data['name_user']; ?> <i style="margin-left:5px"
